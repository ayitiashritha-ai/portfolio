...
export default function Portfolio() {
  ...
  return (
    <div className="flex bg-[#050505] text-gray-300 font-sans min-h-screen selection:bg-amber-500 selection:text-black">

      {/* --- Sidebar --- */}
      <aside className="fixed hidden xl:flex w-[280px] h-screen bg-[#0a0a0a] border-r border-zinc-900 flex-col justify-between z-50">
        <div className="p-8">
      ...
      <main className="flex-1 xl:ml-[280px] w-full min-h-screen relative pb-24">
        ...
        {/* Mobile Header */}
        <div className="xl:hidden sticky top-0 z-50 bg-[#0a0a0a]/90 backdrop-blur-xl border-b border-zinc-900 p-6 flex justify-between items-center">
        ...
        <header className="hidden xl:flex sticky top-0 z-40 bg-[#050505]/90 backdrop-blur-md border-b border-zinc-900 px-12 py-6 justify-between items-center">
          <div>
        ...
        <div className="p-6 md:p-12 lg:px-20 max-w-7xl mx-auto space-y-12">
          ...
          <section id="home" className="scroll-mt-32 pt-10 lg:min-h-[75vh] flex items-center relative">
            <div className="bg-[#0c0c0c] border border-zinc-800 rounded-2xl p-8 lg:p-16 w-full relative overflow-hidden group">
          ...
          <section id="about" className="scroll-mt-32">
            <div className="bg-[#0c0c0c] border border-zinc-800 rounded-2xl p-8 lg:p-16">
          ...
          <section id="skills" className="scroll-mt-32">
            <div className="bg-[#0c0c0c] border border-zinc-800 rounded-2xl p-8 lg:p-12">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                  ...
                  <div key={i} className="bg-[#121212] border border-zinc-800 p-6 rounded-xl hover:border-zinc-700 transition-colors">
          ...
          <section id="experience" className="scroll-mt-32">
            <div className="bg-[#0c0c0c] border border-zinc-800 rounded-2xl p-8 lg:p-12">
              ...
              <div className="border border-zinc-800 border-l-blue-500 border-l-2 p-8 bg-[#121212] rounded-r-xl max-w-4xl relative overflow-hidden group">
          ...
          <section id="projects" className="scroll-mt-32">
            <div className="bg-[#0c0c0c] border border-zinc-800 rounded-2xl p-8 lg:p-12">
              ...
              <div className="grid lg:grid-cols-2 gap-6">
                {/* Project 1 */}
                <div className="bg-[#121212] border border-zinc-800 p-8 rounded-xl hover:border-zinc-700 transition-colors shadow-lg">
          ...
          <section id="certificates" className="scroll-mt-32">
            <div className="bg-[#0c0c0c] border border-zinc-800 rounded-2xl p-8 lg:p-12">
              ...
              <div className="grid lg:grid-cols-2 gap-6">
                {/* Training block */}
                <div className="bg-[#121212] border border-zinc-800 p-8 rounded-xl relative overflow-hidden group">
                ...
                <div className="flex flex-col gap-4">
                  {[
                    ...
                    <a key={j} href={cert.href || "#"} target={cert.href ? "_blank" : undefined} rel="noreferrer" className={`bg-[#121212] border border-zinc-800 p-6 rounded-xl flex items-center justify-between transition-colors ${cert.href ? 'hover:border-amber-500/50 cursor-pointer' : 'hover:border-zinc-700 cursor-default'}`}>
                      <div>
            ...
            <div className="bg-[#0c0c0c] border border-zinc-800 rounded-2xl p-8 lg:p-12">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <motion.div
                  ...
                  className="bg-[#121212] border border-zinc-800 p-8 rounded-xl hover:border-zinc-700 transition-colors shadow-lg flex flex-col cursor-pointer"
                >
          ...
          <section id="education" className="scroll-mt-32">
            <div className="bg-[#0c0c0c] border border-zinc-800 rounded-2xl p-8 lg:p-12">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="border border-zinc-800 border-t-amber-500 border-t-2 p-8 bg-[#121212] rounded-b-xl shadow-lg hover:border-zinc-700 transition-colors">
                ...
                <div className="border border-zinc-800 p-8 bg-[#121212] rounded-xl shadow-lg hover:border-zinc-700 transition-colors">
          ...
          <section id="resume" className="scroll-mt-32">
            <div className="bg-[#0c0c0c] border border-zinc-800 p-8 lg:p-12 rounded-2xl flex flex-col lg:flex-row gap-12 justify-between items-center relative overflow-hidden">
              ...
              <div className="w-full lg:w-[420px] bg-[#121212] border border-zinc-800 rounded-2xl p-6 lg:p-8 shrink-0 shadow-2xl z-10">
          ...
          <section id="contact" className="grid grid-cols-1 lg:grid-cols-2 gap-6 scroll-mt-32">
            ...
            <div className="bg-[#0c0c0c] border border-zinc-800 rounded-2xl p-8 lg:p-12">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {/* Email */}
                <div className="bg-[#121212] border border-zinc-800 rounded-xl p-5 hover:border-zinc-700 transition-colors">
            ...
            {/* Right: Availability */}
            <div className="bg-[#0c0c0c] border border-zinc-800 rounded-2xl p-8 lg:p-12 flex flex-col justify-between">
              <div>
